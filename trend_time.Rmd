...
In this page, we are going to discuss the UFO sightings trend over time. First we will look into the pattern of sightings by states over years, months, weekdays and hours.To get rid off the population effect, we also discuss calculate the sightings per 1 million of each states and then examine the trend over year and month.Then we will explore the sightings by shape over years. 
...
### sightings trend over years by states
...
ufo_year_trend_plot_rm <- 
  ...
  labs(title = "Spaghetti plot of sightings trend of states over years(CA Removed)")
...
### sightings trend of states over months
...
## Trend per population by state over time
...
### Trend per population by state over year
...
### Trend per population by state over month
